            ...
            <div class="row">
                ...
                <div class="panel">
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Vui lòng nhập tên" value="@if(isset($dataTypeContent->name)){{ $dataTypeContent->name }}@endif">
                        </div>
                    </div>
                    <!-- ### TITLE ### -->
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="title" name="title" placeholder="Vui lòng nhập tiêu đề bài giảng " value="@if(isset($dataTypeContent->title)){{ $dataTypeContent->title }}@endif">
                        </div>
                    </div>
                ...
                <!-- category -->
                    <div class="col-md-4">
                        ...
                        <div class="panel panel panel-bordered panel-warning">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="icon wb-clipboard"></i> Lọai bài viết</h3>
                                <div class="panel-actions">
                                    <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                                </div>
                            </div>
